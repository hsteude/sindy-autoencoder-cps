...
Z_COL_NAMES = ['h0', 'h1']
Z_DOT_COL_NAMES = ['h0_dot', 'h1_dot']
TIME_COL_NAME = 'time'
UID_INITIAL_STATE_COL_NAME = 'uid_initial_state'

#path
X_SPACE_DATA_PATH = 'data/processed/two_tank_x_space_data.parquet'
X_SPACE_DATA_PATH_DEBUGGING = 'data/processed/two_tank_x_space_data_debugging.parquet'
